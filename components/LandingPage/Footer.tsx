...
const Footer = () => {
    return (
        <footer className="bg-[#1d3055] text-white py-4 md:py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-lg font-bold mb-4">Event.Co</h3>
                        <p className="text-gray-400">
                            The ultimate platform for discovering and managing events on
                            your campus.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Link href="htpps://linkedin.com" className="text-gray-400 hover:text-white">
